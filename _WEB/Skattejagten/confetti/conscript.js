...
function StartConfetti(){
    ///Elements
    var canvas = document.getElementById("treasuremap");
    var canvasWidth = canvas.clientWidth;
    var canvasHeight = canvas.clientHeight;    
    ///VerletExpressJS
    VX.initialize( "2d", "canvas", "treasuremap", canvasWidth, canvasHeight );
    ...
    // document.getElementById("treasuremap").style.background = backgroundColor;
    ...
    VX.interfaceWidth = canvas.width;
    VX.interfaceHeight = canvas.height;
      // console.log(VX.interfaceWidth);
      // console.log(VX.interfaceHeight);
